...
public final class ExtentLogger {
	...
	public static void pass(String message,boolean isScreenshotNeeded)  {
		...
		if(PropertyFileUtils.get(ConfigProperties.PASSEDSTEPSSCREENSHOT).equalsIgnoreCase("yes") && isScreenshotNeeded) {
	...
	public static void fail(String message,boolean isScreenshotNeeded)  {
		...
		if(PropertyFileUtils.get(ConfigProperties.FAILEDSTEPSSCREENSHOT).equalsIgnoreCase("yes") && isScreenshotNeeded) {
	...
	public static void skip(String message,boolean isScreenshotNeeded)  {
		...
		if(PropertyFileUtils.get(ConfigProperties.SKIPPEDSTEPSSCREENSHOT).equalsIgnoreCase("yes") && isScreenshotNeeded) {
